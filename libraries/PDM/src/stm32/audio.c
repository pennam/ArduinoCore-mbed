...
{
    switch(frequency){
        case AUDIO_FREQUENCY_8K:     return 24;  //SCK_x = sai_x_ker_ck/24 =  2047KHz  Ffs = SCK_x/64 = 32KHz
        //case AUDIO_FREQUENCY_11K:
        case AUDIO_FREQUENCY_16K:    return 12;  //SCK_x = sai_x_ker_ck/12 =  4095KHz  Ffs = SCK_x/64 = 64KHz
        case AUDIO_FREQUENCY_32K:    return  6;  //SCK_x = sai_x_ker_ck/6  =  8190KHz  Ffs = SCK_x/64 = 128KHz
        case AUDIO_FREQUENCY_48K:    return  4;  //SCK_x = sai_x_ker_ck/4  = 12285KHz  Ffs = SCK_x/64 = 192KHz
        case 64000:                  return  3;  //SCK_x = sai_x_ker_ck/3  = 16380KHz  Ffs = SCK_x/64 = 256KHz
        case AUDIO_FREQUENCY_96K:    return  2;  //SCK_x = sai_x_ker_ck/2  = 24571KHz  Ffs = SCK_x/64 = 384KHz
...
int py_audio_init(size_t g_channels, uint32_t frequency, int gain_db, float highpass)
{
    ...
    hsai.Init.Mckdiv                 = get_mck_div(frequency);//AUDIO_SAI_MCKDIV; //2.048MHz
